...
final class MyScalarResponseBodyConverters {

    private MyScalarResponseBodyConverters() {
    }
    ...
    static final class StringResponseBodyConverter implements Converter<ResponseBody, String> {
        ...
        public String convert(ResponseBody value) throws IOException {
            ...
            MyConverterUtil.resolveJson(json, GsonUtil.create());

            JsonObject res = new JsonParser().parse(json).getAsJsonObject();
            json = res.get(MyHttpStatus.KEY_DATA).getAsJsonObject().toString();
