...
import com.example.wubin.recyclerviewadaptermodule.adapter.AnimationAdapter;
import com.example.wubin.recyclerviewadaptermodule.animation.CustomAnimation;
    ...
    private void initAdapter() {
        ...
        mAnimationAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                } else if (i == R.id.tweetName) {
                    content = "name:" + status.getUserName();
                    Toast.makeText(AnimationUseActivity.this, content, Toast.LENGTH_LONG).show();
                } else if (i == R.id.tweetText) {
