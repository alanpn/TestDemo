...
public class PieChartActivity extends DemoBase implements OnSeekBarChangeListener, OnChartValueSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i1 == R.id.viewGithub) {
            ...
            chart.invalidate();
        } else if (i1 == R.id.actionToggleHole) {
            if (chart.isDrawHoleEnabled())
                chart.setDrawHoleEnabled(false);
            else
                chart.setDrawHoleEnabled(true);
            chart.invalidate();
        } else if (i1 == R.id.actionToggleMinAngles) {
            ...
            chart.invalidate();
        } else if (i1 == R.id.actionToggleCurvedSlices) {
            ...
            chart.invalidate();
        } else if (i1 == R.id.actionDrawCenter) {
            if (chart.isDrawCenterTextEnabled())
                chart.setDrawCenterText(false);
            else
                chart.setDrawCenterText(true);
            chart.invalidate();
        } else if (i1 == R.id.actionToggleXValues) {
            chart.setDrawEntryLabels(!chart.isDrawEntryLabelsEnabled());
            chart.invalidate();
        } else if (i1 == R.id.actionTogglePercent) {
