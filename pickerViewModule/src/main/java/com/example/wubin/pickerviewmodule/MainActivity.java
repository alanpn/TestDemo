package com.example.wubin.pickerviewmodule;
...
import com.example.wubin.pickerviewmodule.bean.CardBean;
import com.example.wubin.pickerviewmodule.bean.ProvinceBean;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn_Options, btn_CustomOptions, btn_CustomTime;
    ...
    private void initLunarPicker() {
        ...
        startDate.set(2014, 1, 23); // 正规时间 2014/2/23 月份从0开始
        Calendar endDate = Calendar.getInstance();
        endDate.set(2069, 2, 28); // 正规时间 2069/3/28 月份从0开始
...
//        pvOptions.setSelectOptions(1,1);
    ...
    private void getCardData() {
        ...
        String cardNo, str_item;
        CardBean cardBean;
        for (int i = 0, size = cardItem.size(); i < size; i++) {
            cardBean = cardItem.get(i);
            cardNo = cardBean.getCardNo();
            if (cardNo.length() > 6) {
                str_item = cardNo.substring(0, 6) + "...";
                cardBean.setCardNo(str_item);
            }
        }
    }
