...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.app_version)).setText(getString(R.string.msg_app_version, getVersionName(), "1.="));
        ((TextView) findViewById(R.id.lib_version)).setText(getString(R.string.msg_lib_version, "1.0"));
