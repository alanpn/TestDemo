        ...
        private void createAnimation() {
            ...
            if (animation == null) {
                ...
                ObjectAnimator anim = (ObjectAnimator) AnimatorInflater.
                        loadAnimator(AnimationLoading.this, R.animator.object_animator);
                anim.addUpdateListener(this);
                anim.setTarget(balls.get(0));

                ValueAnimator fader = (ValueAnimator) AnimatorInflater.
                        loadAnimator(AnimationLoading.this, R.animator.animator);
                ...
                AnimatorSet seq = (AnimatorSet) AnimatorInflater.
                        loadAnimator(AnimationLoading.this, R.animator.animator_set);
                seq.setTarget(balls.get(2));

                ObjectAnimator colorizer = (ObjectAnimator) AnimatorInflater.
                        loadAnimator(AnimationLoading.this, R.animator.color_animator);
