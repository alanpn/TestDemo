...
package com.example.wubin.nineoldmodule.apidemos;
...
import com.example.wubin.nineoldmodule.R;
    ...
    public class MyAnimationView extends View implements ValueAnimator.AnimatorUpdateListener {
        ...
        private void createAnimation() {
            if (bounceAnim == null) {
                ...
                ObjectAnimator yAlphaBouncer = ObjectAnimator.ofPropertyValuesHolder(
                        ball, pvhY, pvhAlpha)
                ...
                PropertyValuesHolder pvTX = PropertyValuesHolder.ofFloat(
                        "x", ball.getX(),
                        ball.getX() - BALL_SIZE / 2f);

                PropertyValuesHolder pvTY = PropertyValuesHolder.ofFloat(
                        "y", ball.getY(),
                ...
                pvhY = PropertyValuesHolder.ofFloat(
                        "y", ball.getY(), getHeight() - BALL_SIZE);
                ...
                (bounceAnim = new AnimatorSet()).playTogether(
                        yBouncer, yAlphaBouncer, whxyBouncer, yxBouncer);
            }
        }
